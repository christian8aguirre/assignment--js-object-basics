...
function fullNameArgsToObject(n1, n2, n3) {
  var n1Array = n1.split(" ");
  var n2Array = n2.split(" ");
  var n3Array = n3.split(" ");

  var obj = {
  };

  obj[n1Array[0]] = n1Array[1];
  obj[n2Array[0]] = n2Array[1];
  obj[n3Array[0]] = n3Array[1]; 
  return obj;
}
